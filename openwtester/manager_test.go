...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W97KLBVsEnaVuCZZya59EqqiXzugF78xit")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "W97KLBVsEnaVuCZZya59EqqiXzugF78xit"
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W97KLBVsEnaVuCZZya59EqqiXzugF78xit"
	accountID := "8yuj14PcsMS7CzmGWY8fgYj9c8i1fxevb7fdcSPfNSS3"
...
func TestWalletManager_GetAddressList(t *testing.T) {
	...
	walletID := "W97KLBVsEnaVuCZZya59EqqiXzugF78xit"
	accountID := "8yuj14PcsMS7CzmGWY8fgYj9c8i1fxevb7fdcSPfNSS3" // 3
